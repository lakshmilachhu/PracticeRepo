...
public class MulitWindowHandling_2 {
	public static void main(String[] args) throws InterruptedException {
		...
		WebElement oldStyleDropDownEle = driver.findElement(By.xpath("//button[@id='tabButton']"));
		...
		//after initializing a present window to string variable,
		//then we're utilizing it to any time.
		driver.switchTo().window(parentWindowStr); 
		System.out.println(driver.findElement(By.xpath("//button[@id='tabButton']")).getText());
		driver.close();
	}
